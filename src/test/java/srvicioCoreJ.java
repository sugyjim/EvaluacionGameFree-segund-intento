...
public class srvicioCoreJ {

        private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(srvicioCoreJ.class);
        ...
        public static void validarCodigoEsperado(int codigoRespuestaEsperado){
